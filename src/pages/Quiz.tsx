...
const Quiz = () => {
  ...
  return (
    <Layout>
      <Helmet>
        <title>Self-Discovery Quizzes | InnerPath Journey</title>
        <meta name="description" content="Discover your personalized growth path with our quick self-assessment quizzes. Get tailored recommendations for courses and routines based on your unique needs." />
      </Helmet>
