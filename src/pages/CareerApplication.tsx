...
// Same mock job data as in CareerPosition.tsx
const jobsData = {
  "mindfulness-coach": {
...
const CareerApplication = () => {
  ...
  const handleFileUpload = (name: string) => {
    ...
    toast({
      ...
      description: name === "resumeUploaded" ? "Your resume has been uploaded." : "Your cover letter has been uploaded."
    });
  };
  ...
  return (
    <Layout>
      <Helmet>
        <title>Apply for {job.title} | InnerPath Journey</title>
      ...
      <div className="py-32 px-6 md:px-12">
        <div className="max-w-3xl mx-auto">
          <Link to={`/careers/${id}`} className="flex items-center text-sm text-muted-foreground hover:text-primary mb-6">
