...
const TermsOfService = () => {
  return (
    <Layout>
      <Helmet>
        <title>Terms of Service | InnerPath Journey</title>
        <meta name="description" content="Our terms of service outline the rules and guidelines for using InnerPath Journey." />
      </Helmet>
