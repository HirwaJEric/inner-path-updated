...
const Signup = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-muted/30">
      <Helmet>
        <title>Sign Up | InnerPath Journey</title>
        <meta name="description" content="Create your InnerPath Journey account to access personalized mentorship, courses, and resources for your personal growth journey." />
      </Helmet>
      
      <div className="py-8 px-4 md:px-8">
        <div className="max-w-sm mx-auto">
          <Link to="/" className="text-xl md:text-2xl w-full text-center  font-bold gradient-text inline-block mb-8">
            InnerPath Journey
          </Link>
        </div>
      </div>
