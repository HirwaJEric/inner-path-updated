...
import { ArrowRight, Users, Shield, GraduationCap, Compass } from "lucide-react";
...
const Programs = () => {
  return (
    <Layout>
      <Helmet>
        <title>Our Programs | Mentorship, Career Guidance & Mental Health Support</title>
        <meta name="description" content="Explore our comprehensive programs offering personalized mentorship, career guidance, mental health support, and life direction services." />
        <meta name="keywords" content="mentorship programs, career guidance services, mental health support, life coaching, personal growth programs" />
      </Helmet>
