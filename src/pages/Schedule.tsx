...
const Schedule = () => {
  ...
  const onSubmit = async (data: FormValues) => {
    ...
    toast({
      ...
      description: `Your ${consultationType?.label} has been scheduled for ${format(data.date, "PPPP")} at ${data.time}.`,
    });
  ...
  return (
    <Layout>
      <div className="container mx-auto py-12 px-4">
        <Helmet>
          <title>Schedule a Consultation | InnerPath Journey</title>
          <meta name="description" content="Book a consultation with our experts." />
        </Helmet>
