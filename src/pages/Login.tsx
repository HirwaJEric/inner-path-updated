...
const Login = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-muted/30">
      <Helmet>
        <title>Login | InnerPath Journey</title>
        <meta name="description" content="Log in to your InnerPath Journey account to access your courses, mentorship sessions, and personal dashboard." />
      </Helmet>
