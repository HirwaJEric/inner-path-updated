            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
              <div className="space-y-4">
                ...
                <ul className="space-y-3 text-sm">
                  <li>
                    <Link to="/programs" className="text-foreground/80 hover:text-primary transition-colors">
                      1-on-1 Mentorship
                    </Link>
                  </li>
                  <li>
              ...
              <div className="space-y-4">
                ...
                <ul className="space-y-3 text-sm">
                  ...
                  <li>
                    <Link to="/assessment" className="text-foreground/80 hover:text-primary transition-colors">
                      Self-Assessment
                    </Link>
                  </li>
                  <li>
