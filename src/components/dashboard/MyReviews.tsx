...
const MyReviews = () => {
  ...
  const handleEditReview = (product) => {
    setSelectedProduct(product);
    setIsReviewSheetOpen(true);
  };
  
  const handleDeleteReview = (product) => {
  ...
  const confirmDeleteReview = () => {
    ...
    toast({
      ...
      description: `Your review for ${reviewToDelete.name} has been successfully deleted.`,
    });
  ...
  const handleReviewSubmitted = () => {
    ...
    toast({
      ...
      description: `Your review for ${selectedProduct.name} has been successfully ${selectedProduct.hasReviewed ? 'updated' : 'submitted'}.`,
    });
  };
