          ...
          <Card key={index} className="animate-fade-in">
            <CardContent className="p-6">
              <div className="flex justify-between items-start mb-4">
                ...
                <Link to={stat.link} className="text-muted-foreground hover:text-primary">
            ...
            {upcomingSessions.length > 0 ? (
              ...
              <div className="text-center py-6">
                ...
                <Button size="sm" asChild>
                  <Link to="/programs">Book a Session</Link>
                </Button>
              </div>
            )}
          </CardContent>
          ...
          <div className="grid md:grid-cols-2 gap-4">
            <div className="rounded-lg bg-muted/50 p-4 flex items-start">
              ...
              <div>
                ...
                <Button size="sm" asChild>
                  <Link to="/courses/emotional-intelligence-mastery">
                    View Course
                  </Link>
                </Button>
              </div>
