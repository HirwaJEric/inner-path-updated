          ...
          <NavigationMenuContent>
            <div className="grid w-[400px] gap-3 p-4 md:w-[500px]">
              ...
              <ul className="grid gap-2">
                <li>
                  <Link to="/about" className="flex items-center gap-2 p-2 hover:bg-accent rounded transition-colors">
                ...
                <li>
                  <Link to="/careers" className="flex items-center gap-2 p-2 hover:bg-accent rounded transition-colors">
            ...
            <div className="grid w-[400px] gap-3 p-4 md:w-[600px] md:grid-cols-2 lg:w-[700px]">
              <div className="rounded-lg bg-gradient-to-b from-muted/50 to-muted/80 p-4">
                ...
                <ul className="space-y-2 text-sm">
                  <li>
                    <Link to="/community" className="flex items-center justify-between hover:text-primary">
                      <span>Community Forums</span>
                      <ArrowRight className="h-3 w-3" />
                    </Link>
                  </li>
                  <li>
                    <Link to="/gallery" className="flex items-center justify-between hover:text-primary">
              ...
              <div className="rounded-lg bg-gradient-to-b from-muted/50 to-muted/80 p-4">
                ...
                <ul className="space-y-2 text-sm">
                  <li>
                    <Link to="/schedule" className="flex items-center justify-between hover:text-primary">
                      <span>Schedule a Session</span>
                      <ArrowRight className="h-3 w-3" />
                    </Link>
                  </li>
                  <li>
                    <Link to="/shop" className="flex items-center justify-between hover:text-primary">
                      <span>Wellness Products</span>
                      <ArrowRight className="h-3 w-3" />
                    </Link>
                  </li>
                  <li>
                    <Link to="/contact" className="flex items-center justify-between hover:text-primary">
